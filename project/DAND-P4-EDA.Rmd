...
ggpairs(wine_quality, columns = wq.names.sulphur, mapping = aes(color = quality))
```

```{r echo=FALSE, Bivariate_Plots3}
wq.names.alcohol <- c("alcohol", "residual.sugar", "density")
ggpairs(wine_quality, columns = wq.names.alcohol, mapping = aes(color = quality),lower = list(alpha = 0.01))
```
