...
ggplot(wine_quality, aes(x = quality, y = alcohol)) +
  geom_boxplot()
```
That's better. With the box plot you can the trend from the scatter plot more clearly. Most of the lower scores tend to have an alcohol content aroun 10. Scores of 5 are densly packed around the mean with several outliers, some of which are extreme. Starting with scores of 6 and above there seems to be an upward trend in the mean alcohol content. To keep this in prespective I want to remind myself how many observations fall in to each of the scores.
