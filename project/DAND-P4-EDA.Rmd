...
With the linear model overlayed over the original plot the cure is no longer perceptable.
...
There is a moderate, negative relationship between the volatile.acidity measurements and the citric.acid measurements. I wasn't expecting these two measurements to be related.
I found there was a postitive relationship between fixed.acidity and citric.acid. 
